...
#define _nstates0	144	/* :init: */
#define minseq0	0
#define maxseq0	142
#define _endstate0	143
...
#define Air0	(sizeof(P0) - Offsetof(P0, _1_8_sum) - 1*sizeof(int))
...
#define HAS_TRACK	0
/* hidden variable: */	uchar sequence[5];
/* hidden variable: */	int maxSum[5];
