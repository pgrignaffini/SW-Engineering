...
#define _nstates0	10	/* evenOutput */
#define minseq0	0
#define maxseq0	8
#define _endstate0	9
...
#define PevenOutput	((P0 *)this)
typedef struct P0 { /* evenOutput */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 5; /* state    */
#ifdef HAS_PRIORITY
...
#define Air0	(sizeof(P0) - Offsetof(P0, v) - 1*sizeof(uchar))
