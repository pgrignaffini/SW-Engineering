...
#define _nstates2	11	/* SafetyMaxOnRope */
#define minseq2	52
#define maxseq2	61
...
typedef struct P2 { /* SafetyMaxOnRope */
...
#define Pmonkey	((P0 *)this)
typedef struct P0 { /* monkey */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
